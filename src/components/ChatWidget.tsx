  ...
  return (
    <>
      ...
      <motion.button
        ...
        style={{ boxShadow: "0 8px 32px rgba(93,169,167,0.35), 0 2px 8px rgba(31,59,94,0.12)" }}
        ...
        {open && (
          ...
          >
            <div className="flex flex-col rounded-2xl overflow-hidden border border-ivory/8"
              style={{ boxShadow: "0 24px 80px rgba(31,59,94,0.18), 0 0 0 1px rgba(93,169,167,0.15)" }}
            >
              {/* Header */}
